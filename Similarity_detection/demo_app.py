...
import os
from demo_similarity import similar_k
import cv2
...
async def root(request:Request,image_id:str,k:int):
    ...
    print(image_id)
    org,top,bottom = similar_k(image_id,k)
    ...
    return templates.TemplateResponse("demo_temp.html",{"request":request,"original_image":original_image,"topwear_image":topwear_image,"bottomwear_image":bottomwear_image})
